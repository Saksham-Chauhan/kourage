...
async def on_react(bot, ctx, user, ticket_channel, _logger):
    ...
    organisation_name_embed=discord.Embed(title="",description="Please enter your Organisation's Name?",colour=0x11806a)
    ...
    reason_embed=discord.Embed(title="",description="Please specify why do you want to be partners with us.",colour=0x11806a)
